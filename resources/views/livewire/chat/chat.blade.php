@extends('layouts.app')
@section('content')
    {{-- Replace with your layout path --}}
    <div
        class="hidden lg:flex fixed h-full flex bg-white border lg:shadow-sm overflow-hidden inset-0 lg:top-16 lg:inset-x-2 m-auto lg:h-[90%] rounded-t-lg">
